...
plugins {
    ...
    id("org.openapi.generator") version "6.4.0" apply true
}
...
tasks {
    ...
    openApiGenerate {
        ...
        inputSpec.set("$rootDir/specs/missionControl.json")
        outputDir.set("$buildDir/generated")
        apiPackage.set("com.solace.mc.api")
        invokerPackage.set("com.solace.mc.invoker")
        modelPackage.set("com.solace.mc.model")
    }
}
